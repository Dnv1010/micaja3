...
'}',
'export function GastosGeneralesClient({ sector, responsable, rol, chatId }: { sector: string; responsable: string; rol: string; chatId: string }) {',
...
fs.writeFileSync('components/coordinador/gastos-generales-client.tsx', lines.join('\n'), 'utf8');
console.log('OK');
