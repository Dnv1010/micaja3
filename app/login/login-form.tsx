...
const ERROR_MESSAGES: Record<string, { title: string; body: string }> = {
  ...
  AccessDenied: {
    ...
    body:
      "Tu cuenta no está autorizada: debe ser @bia.app, aparecer en la hoja Usuarios con UserActive activo, y el correo debe coincidir exactamente con el de la hoja.",
  },
  Callback: {
